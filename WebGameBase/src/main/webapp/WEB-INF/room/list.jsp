...
<%@page import="com.thkmon.wgbase.room.data.RoomData"%>
<%@page import="com.thkmon.wgbase.room.data.RoomDataList"%>
<%@page import="com.thkmon.wgbase.room.util.RoomServiceUtil"%>
<!DOCTYPE html>
<html>
<head>
...
// 		location.href = "/room/list";
	...
	function enterToRoom(_roomId) {
		...
		sendPost("/room/room", keyArray, valueArray);
	}
...
<body>
	...
	<div class="roomDiv">
		<%
			RoomDataList roomDataList = RoomServiceUtil.getRoomDataList();
